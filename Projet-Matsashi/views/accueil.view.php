...
<section id="accueil-biblio">
    ...
    <div class="row mb-5  accueil-mobile">
        <div class="col">
            <a href="<?=URL?>bibliotheque/microsoft">
                <img src="<?=URL?>public/images/index/controller_microsoft.png" width="50%">
            </a>
        </div>
    </div>
    <div class="row mb-2 accueil-mobile">
        <div class="col">
            <a href="<?=URL?>bibliotheque/microsoft/pc/dofus">
                <img src="<?=URL?>public/images/index/Dofus.jpg" width="75%" class="game-selection">
            </a>
    ...
    <div class="row mb-5  accueil-mobile">
        <div class="col">
            <a href="<?=URL?>bibliotheque/sega">
                <img src="<?=URL?>public/images/index/controller_genesis.png" width="50%">
            </a>
        </div>
    </div>
    <div class="row mb-2 accueil-mobile">
    ...
    <div class="row mb-5  accueil-mobile">
        <div class="col">
            <a href="<?=URL?>bibliotheque/nintendo">
                <img src="<?=URL?>public/images/index/controller_switch.png" width="50%">
            </a>
        </div>
    </div>
    <div class="row mb-2 accueil-mobile">
    ...
    <div class="row mb-5  accueil-mobile">
        <div class="col">
            <a href="<?=URL?>bibliotheque/sony">
                <img src="<?=URL?>public/images/index/controller_sony.png" width="50%">
            </a>
        </div>
    </div>
    <div class="row mb-2 accueil-mobile">
